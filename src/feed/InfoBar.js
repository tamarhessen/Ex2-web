...
function Center() {
    return (
        <div className="column CenterAlign TopBar" style={{ display: 'flex', alignItems: 'center', height: '200%' }}>
    ...
    function RightSide({ userImg }) {
        return (
            <div className="column RightAlign TopBar" style={{ display: 'flex', height: '200%' }}>
                <button className={"btn"} >Find friends</button>
                <button className={"btn"} >Menu</button>
                <button className={"btn"}>Message</button>
                <button className={"btn"} >Notifications</button>
                <img src={userImg} className={"Logo"} style={{ height: '200%' }}></img>
            </div>
        );
    }
